...
BEGIN
  ...
  INSERT INTO eqged.gem_exposure 
    ...
    ms_class_name_occ, ms_class_name_age, ms_value, gem_material_type, 
    gem_material_technology, gem_material_property, gem_vertical_load_system, 
    gem_ductility, gem_roof_system, gem_floor_system, gem_height_category, 
  ...
  SELECT
    ...
    pg.gem_material_type, pg.gem_material_technology, pg.gem_material_property, 
    pg.gem_vertical_load_system, pg.gem_ductility, pg.gem_roof_system, pg.gem_floor_system, pg.gem_height_category, pg.gem_shorthand_form,
